...
console.log("cuantificador existencial: ", parseOperationCalculo(sentenciaCuantificadores1)); // SELECT * FROM Estudiantes_BD WHERE EXISTS (SELECT 1 FROM Estudiantes_POO g WHERE Estudiantes_BD.rut = g.rut)
...
console.log("cuantificador universal: ", parseOperationCalculo(sentenciaCuantificadores2)); // SELECT * FROM Estudiantes_BD WHERE NOT EXISTS (SELECT 1 FROM Estudiantes_POO g WHERE NOT(Estudiantes_BD.Ingreso <= g.Ingreso))
...
console.log("cuantificador existencial2: ", parseOperationCalculo(sentencia1)); // SELECT * FROM Empleados WHERE EXISTS (SELECT 1 FROM Departamentos g WHERE Empleados.salario > 30000)
...
console.log("cuantificador universal2: ", parseOperationCalculo(sentencia2)); // SELECT * FROM Proyectos WHERE NOT EXISTS (SELECT 1 FROM Empleados g WHERE NOT(Proyectos.presupuesto > g.salario))
